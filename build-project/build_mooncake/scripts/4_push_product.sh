...
require_env WORKSPACE SIGNATURE_FILE SIGNATURE_ARGS
...
cd "${DIST_DIR}/images/"
python "${SIGNATURE_FILE}"/cms_signature.py --file "${DIST_DIR}/images/package.mf" "${SIGNATURE_ARGS}"
...
python "${SIGNATURE_FILE}"/cms_signature.py --file "${DIST_DIR}/charts/mooncake_store_server/package.mf" "${SIGNATURE_ARGS}"
...
# 内签第2层
cd "${DIST_DIR}/charts/"
python "${SIGNATURE_FILE}"/cms_signature.py --file "${DIST_DIR}/charts/package.mf" "${SIGNATURE_ARGS}"
